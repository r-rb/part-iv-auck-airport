...
def loadplane(kml, isManual):
    ...
    if isManual:
        ...
        plane.append(Plane("Flight A", 175.0, -37.0, 3, akl, kml))
        plane.append(Plane("Flight B", 176.0, -39.0, 2, akl, kml))
        #plane.append(Plane("Flight C", 180.0, -39.5, 4, akl, kml))
        plane.append(Plane("Flight C", 172.0, -36.0, 4, akl, kml))
        plane.append(Plane("Flight D", 173.0, -35.0, 2, akl, kml))
        plane.append(Plane("Flight E", 174.0, -37.0, 3, akl, kml))
        #plane.append(Plane("Flight G", 175.0, -33.0, 4, akl, kml))
        plane.append(Plane("Flight F", 176.4, -38.4, 3, akl, kml))
